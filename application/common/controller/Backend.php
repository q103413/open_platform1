...
class Backend extends Controller
{
    ...
    public function _initialize()
    {
        ...
        if ( $_SESSION && array_key_exists('think',$_SESSION) && array_key_exists('admin',$_SESSION['think']) ) {
            $this->uid = (int)json_decode( $_SESSION['think']['admin'])->id;
        }
        //当前用户级别，暂根据pid来取
        // $backend = new \app\admin\library\traits\Backend();
